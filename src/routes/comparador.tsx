			...
			{origen && destino && (
				<section>
					...
					<div className="mt-6 grid gap-6 md:grid-cols-2">
						<div className="overflow-hidden rounded-2xl border border-white/60 bg-white/70 shadow-[0_16px50px_rgba(16,47,55,0.1)] backdrop-blur-sm">
					...
					<div className="mt-6 overflow-hidden rounded-2xl border border-white/60 bg-white/70 shadow-[0_16px50px_rgba(16,47,55,0.1)] backdrop-blur-sm">
						<div className="border-b border-[#d0e0d8] px-5 py-3">
							<h3 className="text-sm font-bold text-[#102f37]">
								Por Tiempo de Viaje
								{Object.keys(sliderState).length > 0 && (
